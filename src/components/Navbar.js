...
export default function Navbar({ title, aboutText = 'About', mode, toggleMode, textEnable }) {
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className={`form-check form-switch text-${mode === 'dark' ? 'light' : 'dark'}`}>
            ...
            <label className="form-check-label" htmlFor="flexSwitchCheckDefault">{textEnable}</label>
          </div>
        </div>
      </div>
    </nav>
...
Navbar.propTypes = {
  ...
  textEnable: PropTypes.string.isRequired
};
